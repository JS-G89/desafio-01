/* Capturar usuário e senha digitados
   Verificar se o usuário e senha estão corretos
   Se estiver correto, logar na tela principal
   Ser estiver errado, mandar mensagem e continuar na tela de login*/
   ...
   let btnEntrar = document.getElementById(`btn-logar`);
...
const divBoxLogin = document.querySelector('div.tela-login');
